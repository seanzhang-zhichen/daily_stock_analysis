...
export const ReportPriceHistory: React.FC<ReportPriceHistoryProps> = ({
  ...
  return (
    <Card variant="bordered" padding="md" className="report-price-history text-left">
      <div className="report-price-chart-block">
        ...
        <div className="report-price-chart h-64 min-w-0">
      ...
      <div className="report-price-table mt-4 overflow-x-auto rounded-xl border border-subtle">
