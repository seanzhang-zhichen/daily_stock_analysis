---
applyTo: "main.py,server.py,webui.py,backend/**/*.py,src/**/*.py,data_provider/**/*.py,api/**/*.py,bot/**/*.py,tests/**/*.py"
---
...
- Changes in `backend/data_provider/` must preserve provider priority, normalization behavior, timeout/retry expectations, and graceful degradation.
