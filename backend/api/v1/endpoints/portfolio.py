...
@router.post(
    ...
    summary="Submit analysis for a held portfolio position",
)
def analyze_position(
    ...
    if duplicates:
        ...
        response = DuplicateTaskErrorResponse(
...
def _resolve_position_analysis_context(
    ...
    *,
    ...
    account, position, normalized_symbol = matches[0]
    return {
        "account_id": account.get("account_id"),
        "account_name": account.get("account_name"),
        "symbol": normalized_symbol or target,
