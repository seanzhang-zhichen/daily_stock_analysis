...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LITELLM_CONFIG": {
        ...
        "description": "Path to an advanced model routing YAML file (expert use). When valid/parseable and yields a model_list, it takes priority over channels and explicit direct model settings; otherwise channels/direct settings are used as fallback.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "RUN_IMMEDIATELY": {
        ...
        "description": "Run one analysis immediately in non-scheduler startup mode. Scheduler mode uses SCHEDULE_RUN_IMMEDIATELY.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "DAILY_QUOTE_SYNC_ENABLED": {
        "title": "Daily Quote Sync Enabled",
        "description": "Enable full-market daily OHLCV sync before scheduled analysis runs. Currently supports CN A-shares.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 70,
        "help_key": "settings.data_source.DAILY_QUOTE_SYNC_ENABLED",
        "examples": [
        ...
        "warning_codes": ["network_usage", "restart_required"],
    },
    "DAILY_QUOTE_SYNC_MARKETS": {
        "title": "Daily Quote Sync Markets",
        "description": "Comma-separated markets for full daily quote sync. The first version supports cn only.",
        "category": "data_source",
        "data_type": "array",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 71,
        "help_key": "settings.data_source.DAILY_QUOTE_SYNC_MARKETS",
        "examples": ["DAILY_QUOTE_SYNC_MARKETS=cn"],
        "docs": [
            {
                "label": "完整指南：其他配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#其他配置",
        ...
        "warning_codes": ["cn_only"],
    },
    "DAILY_QUOTE_SYNC_MAX_WORKERS": {
        "title": "Daily Quote Sync Workers",
        "description": "Maximum worker threads for full daily quote sync.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 72,
        "help_key": "settings.data_source.DAILY_QUOTE_SYNC_MAX_WORKERS",
        "examples": ["DAILY_QUOTE_SYNC_MAX_WORKERS=3"],
        "docs": [
            {
                "label": "完整指南：其他配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#其他配置",
        ...
        "warning_codes": ["provider_rate_limit"],
    },
    "DAILY_QUOTE_SYNC_LOOKBACK_DAYS": {
        "title": "Daily Quote Sync Lookback Days",
        "description": "Calendar-day window used when fetching each stock during full daily quote sync.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"minimum": 1},
        "display_order": 73,
        "help_key": "settings.data_source.DAILY_QUOTE_SYNC_LOOKBACK_DAYS",
        "examples": ["DAILY_QUOTE_SYNC_LOOKBACK_DAYS=30"],
        "docs": [
            {
                "label": "完整指南：其他配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#其他配置",
    ...
    "DAILY_QUOTE_SYNC_LIMIT": {
        "title": "Daily Quote Sync Limit",
        "description": "Optional maximum number of stocks to sync. Use 0 for no limit; mainly useful for testing.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 74,
        "help_key": "settings.data_source.DAILY_QUOTE_SYNC_LIMIT",
        "examples": ["DAILY_QUOTE_SYNC_LIMIT=0"],
        "docs": [
            {
                "label": "完整指南：其他配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#其他配置",
    ...
    "DAILY_MARKET_CONTEXT_ENABLED": {
        "title": "Daily A-share Market Context",
        "description": "Inject the daily A-share market summary into stock analysis and soften aggressive buy advice during high-risk or cooling conditions.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_DEEP_RESEARCH_MAX_SUB_QUESTIONS": {
        "title": "Deep Research Max Sub-Questions",
        "description": "Upper bound for model-planned Deep Research sub-questions. The planner may stop earlier when coverage is sufficient.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_DEEP_RESEARCH_SUB_QUESTION_STEPS": {
        "title": "Deep Research Per-Question Steps",
        "description": "Maximum ReAct/tool loop steps for each Deep Research sub-question.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
