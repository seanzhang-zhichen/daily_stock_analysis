...
PROJECT_URL = ""
PROJECT_REPOSITORY = "AlphaLens"
PROJECT_DISPLAY_NAME = "AlphaLens 智能投研"
...
_POSTER_TEXT = {
    "zh": {
        ...
        "open_source": "智能研究助手", "xiaohongshu": "社交账号",
    ...
    "en": {
        ...
        "open_source": "AI Research Assistant", "xiaohongshu": "Social",
...
def _footer(branding: ShareImageBranding, source_line: str, language: str) -> str:
    ...
    <footer class="poster-footer">
      <div class="{brand_class}">
        <div class="footer-title"><strong>AL</strong><span>{_escape(PROJECT_DISPLAY_NAME)}</span></div>
...
<body>
  <main class="poster {report_kind}">
    <header class="poster-header"><div class="brand"><span class="brand-mark" aria-hidden="true"><i></i><i></i><i></i></span><strong>AlphaLens</strong><em>|</em> {_escape(_poster_text(language, "brand"))}</div><div class="meta"><span class="date-chip">{_escape(stamp)}</span></div></header>
